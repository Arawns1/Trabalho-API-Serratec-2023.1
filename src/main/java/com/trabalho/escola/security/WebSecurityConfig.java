	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/auth/**").permitAll() //define as rotas publicas/abertas
                    .requestMatchers("/instrutores/**", "/turmas/**").hasRole("ADMIN") // autoriza o acesso a rotas por perfil
                    .requestMatchers("/turmas/**").hasAnyRole("USER", "MODERATOR","INSTRUTOR") //autoriza o acesso a rotas por perfis
